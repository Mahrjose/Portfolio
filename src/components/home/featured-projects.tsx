...
export function FeaturedProjects() {
  ...
  const scroll = (direction: "left" | "right") => {
    ...
    container.scrollBy({ left: (direction === "left" ? -1 : 1) * visibleCards * cardWidth, behavior: "smooth" });
  };
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-12 animate-fade-in-up">
            <div className="mb-6 sm:mb-0">
              <h2 className="text-3xl sm:text-4xl font-bold mb-2 gradient-text">Featured Projects</h2>
